            ...
            <div class="col-md-5 col-lg-4">
                ...
                <div class="card shadow border-0">
                    ...
                    <div class="card-body p-4 bg-custom-card">
                        ...
                        <form class="list" method="post" action="<?php echo e(route('cuidador.post', $convite->token)); ?>">

                            <!-- Nome -->
                            <div class="mb-3">
                                <label class="form-label txt-small">Nome</label>
                                <input class="form-control form-control-lg txt-small" placeholder="Insira seu nome..." name="nome" value="<?php echo e(isset($cadastro) ? $cadastro->nome : ''); ?>" required/>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="#" class="form-control form-control-lg txt-small" placeholder="Insira seu telefone..." name="telefone" value="<?php echo e(isset($cadastro) ? $cadastro->telefone : ''); ?>" required/>
                            </div>
...
<?php echo $__env->make("login/index", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\TCC\resources\views/email/cadastro.blade.php ENDPATH**/ ?>