        ...
        <div class="col-6 col-md-3">
            <div class="dashboard-card card-yellow p-3 h-100 d-flex flex-column">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <div class="card-value mt-1"><?php echo e($totalPulseira); ?></div>
            </div>
        </div>
        <!-- Idosos - Verde -->
        <div class="col-6 col-md-3">
            <div class="dashboard-card card-green p-3 h-100 d-flex flex-column">
                ...
                <div class="card-value mt-1"><?php echo e($totalIdoso); ?></div>
            </div>
        </div>
        <!-- Cuidadores - Azul -->
        <div class="col-6 col-md-3">
            <div class="dashboard-card card-blue p-3 h-100 d-flex flex-column">
                ...
                <div class="card-value mt-1"><?php echo e($totalCuidador); ?></div>
            </div>
        </div>
        <!-- Quedas - Vermelho -->
        <div class="col-6 col-md-3">
            <div class="dashboard-card card-red p-3 h-100 d-flex flex-column">
                ...
                <div class="card-value mt-1"><?php echo e($totalQueda); ?></div>
            </div>
        </div>
    </div>
